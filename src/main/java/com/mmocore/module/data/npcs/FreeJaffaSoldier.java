 ...
 * @author draks
 */
public class FreeJaffaSoldier {

    public static RegisterableNpc get() {
            RegisterableNpc npc = new RegisterableNpc("Jaffa Soldier", "Goauld Loyal Jaffa", NpcTexture.JAFFA_WARRIOR_ARMOR, NpcModifier.RANGED_SOLDIER, NpcSpawnMethod.Static, NpcFactionAPI.getRegistered("Free Jaffa Nation"));
