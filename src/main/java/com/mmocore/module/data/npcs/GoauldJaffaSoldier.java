 ...
 * @author draks
 */
public class GoauldJaffaSoldier {

    public static RegisterableNpc get() {
            RegisterableNpc npc = new RegisterableNpc("Jaffa Soldier", "Goauld Loyal Jaffa", NpcTexture.JAFFA_SERPENT_GUARD, NpcModifier.RANGED_SOLDIER, NpcSpawnMethod.Static, NpcFactionAPI.getRegistered("Goauld"));
