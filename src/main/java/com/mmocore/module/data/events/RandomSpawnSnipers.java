 ...
 * @author draks
 */
public class RandomSpawnSnipers extends RandomSpawnEvent {

    public RandomSpawnSnipers() {
            super("Random Spawn Snipers - Uncontrolled Worlds");
            this.addNpc(AbstractDictionary.getNpcByName("Tauri Sniper", "Stargate Command"));
