...
public class GuiElement extends Gui {
    ...
    private void renderAsSmallToast() {
        this.drawScaledString(title, (this.getScaledWidth() / 2),  (this.getScaledHeight() / 2) + (this.getScaledHeight() / 5), titleColor, (float)1.0, true);
        this.drawScaledString(subtitle, (this.getScaledWidth() / 2), (this.getScaledHeight() / 2) + (int)(this.getScaledHeight() / 4), subtitleColor, (float)0.75, true);
